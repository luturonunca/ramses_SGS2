...
module mechanical_commons
   ...
   integer(kind=4),parameter::nvarSN=10
   ...
   real(dp)::ESN,f_load,f_left,f_esn 
   ...
   real(dp),dimension(1:ncomm_max)::mSN_comm          ! mass of SNe 
   ...
   real(dp),dimension(1:3,1:ncomm_max)::xSN_comm      ! pos of leaf cells
...
subroutine init_mechanical
   ...
   ok=.false.
   if(boxlen.ne.1)then
      print *, '>>> mechanical Err: Please set boxlen=1'
      ok=.true.
   endif
