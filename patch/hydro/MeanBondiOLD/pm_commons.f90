module pm_commons
  ...
  real(dp),allocatable,dimension(:)    ::dMsink_overdt,dMBHoverdt,wdmg_new,wdmg
  real(dp),allocatable,dimension(:)    ::dMsmbh_overdt,dMBHoverdt_smbh,r2sink
  real(dp),allocatable,dimension(:)    ::rho_gas,volume_gas,eps_sink,c2sink,r2k
  real(dp),allocatable,dimension(:,:)  ::vel_gas
  real(dp),allocatable,dimension(:)    ::delta_mass,delta_mass_new,delta_mass_all,w_c2,wc2_new
  ...
  real(dp),allocatable,dimension(:,:)  ::xsink_graddescent,weighted_c2
