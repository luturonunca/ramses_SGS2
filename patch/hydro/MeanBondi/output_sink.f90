subroutine output_sink_csv(filename)
  ...
  !======================
  write(123,'(" # id,msink,x,y,z,vx,vy,vz,lx,ly,lz,tform,acc_rate_applied,del_mass,rho_gas,cs**2,etherm,vx_gas,vy_gas,vz_gas,mbh,level,dMtorque,dMtorque2,dMbondi2,dMtorque_rot,dMbondi_norot,M_star_cloud,M_star_disc_rot,dMtorque_star ")')
  write(123,'(" # 1,m,l,l,l,l t**-1,l t**-1,l t**-1,m l**2 t**-1,m l**2 t**-1,m l**2 t**-1,t,m t**-1,m,m l**-3,l**2 t**-2,m l**2 t**-2,l t**-1,l t**-1,l t**-1,m,1,m t**-1,m t**-1,m t**-1,m t**-1,m t**-1,m,m,m t**-1 ")')
  do isink=1,nsink
     write(123,'(I10,20(A1,ES20.10),A1,I10,8(A1,ES20.10))')idsink(isink),',',msink(isink),&
