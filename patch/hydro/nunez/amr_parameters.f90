module amr_parameters
  ...
  real(dp)::M_SNII=2.5d0       ! Mean progenitor mass of the TypeII SNe usually 19 has been changed to 2.5 to reduce SFR acounting for four times the amount of SN per explotion (Arturo)
